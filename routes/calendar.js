...
{const today = moment();
  ...
  monthly_food=[0,0]
  request('https://open.neis.go.kr/hub/SchoolSchedule?KEY=b14f10f6a4024b34b57531b5c8117a7e&Type=json&pIndex=1&pSize=100&ATPT_OFCDC_SC_CODE=B10&SD_SCHUL_CODE=7010201&AA_YMD='+moment().format('YYYYMMDD'), (err, res, body) => {
...
try{
  var dd = '\n'+monthly_food[0]['SchoolSchedule'][1]['row'][3]['EVENT_NM'];
	...
	var text = aa+bb+cc+dd
	  text=(day.getMonth()+1)+"월 "+(day.getDate())+"일 학사일정\n\n"+text;      
  return text;
}
